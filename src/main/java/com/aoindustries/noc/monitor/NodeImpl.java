...
public abstract class NodeImpl extends UnicastRemoteObject implements Node {
  ...
  protected static <E extends NodeImpl> List<E> getSnapshot(
    ...
    if (child2 == null) {
      return getSnapshot(child1, child3);
    }
    if (child3 == null) {
      return getSnapshot(child1, child2);
    }
  ...
  protected static <E extends NodeImpl> List<E> getSnapshot(
    ...
    if (child2 == null) {
      return getSnapshot(child1, child3, child4);
    }
    if (child3 == null) {
      return getSnapshot(child1, child2, child4);
    }
    if (child4 == null) {
      return getSnapshot(child1, child2, child3);
    }
   ...
   *
   * @see NodeImpl#constrainAlertLevel(com.aoindustries.noc.monitor.common.AlertLevel)
   */
  @Override
