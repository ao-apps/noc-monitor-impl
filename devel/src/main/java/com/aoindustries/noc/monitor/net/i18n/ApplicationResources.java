...
package com.aoindustries.noc.monitor.net.i18n;
...
public final class ApplicationResources extends EditableResourceBundle {
  ...
  static File getSourceFile(String filename) {
    try {
      return new File(System.getProperty("user.home") + "/maven2/ao/noc/monitor/impl/src/main/resources/com/aoindustries/noc/monitor/net/i18n", filename);
